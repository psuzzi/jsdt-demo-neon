= JSDT demo 01
Patrik Suzzi (c) <psuzzi@gmail.com>
...
Prerequisites:: JSDT integrates with Node.js and node tools you have installed on your system. To run this demo, you should check you have installer node, npm and bower.
...
[source, javascript]
----
include::launch-static-server.js[lines=8..20]
----
